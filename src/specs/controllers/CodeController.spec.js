...
describe("CodeController 단위 테스트", () => {
  ...
  it("code 생성", async () => {
    ...
    const expected_new_code = new CodeBuilder("title", "language", 1)
      .setContent("content")
  ...
  it("code 삭제 실패(400)", async () => {
    await expect(
      controllers.deleteCode(new FakeRequestBuilder().build())
  ...
  it("code 수정 실패(400)", async () => {
    await expect(
      controllers.modifyCode(new FakeRequestBuilder().build())
    ).rejects.toThrow(BadRequest);
  });
  ...
  it("code list 얻기 실패(400)", async () => {
    await expect(
      controllers.getCodes(new FakeRequestBuilder().build())
    ).rejects.toThrow(BadRequest);
  });
  it("code 얻기", async () => {
  ...
  it("code 얻기 실패(400)", async () => {
    await expect(
      controllers.getCode(new FakeRequestBuilder().build())
    ).rejects.toThrow(BadRequest);
  });
  it("code 검색 성공", async () => {
    const req = new FakeRequestBuilder()
