...
CodeRepo.repo.hasMany(StaringRepo.repo, {sourceKey: 'id', foreignKey: 'code_id'});
StaringRepo.repo.belongsTo(CodeRepo.repo, {as: 'stared_code', sourceKey: 'id', foreignKey: 'code_id'});
